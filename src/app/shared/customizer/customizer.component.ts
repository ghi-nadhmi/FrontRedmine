...
export class CustomizerComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        this.layoutSub = layoutService.toggleCustomizerChangeEmitted$.subscribe(
            value => {
                console.log(value);
                this.isOpen = value;
        ...
        this.layoutSub1 = layoutService.customizerChangeEmitted$.subscribe(
            options => {
                if (options) {
                    if (options.bgColor) {
